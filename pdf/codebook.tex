...
\titlespacing*{\section} {0pt}{*1}{*0}  % minimize margin
\titlespacing*{\subsection} {0pt}{*1}{*0} % minimize margin
\titlespacing*{\subsubsection} {0pt}{*1}{*0} % minimize margin
...
\newcommand{\IncludeCpp}[2]{
    \subsection[#1] {#1
        \immediate\write18{./hash.sh \Prefix"#2"}
        {\small [\immediate\protect\input{/tmp/hash/pdf/\Prefix#2.md5}\unskip]}
    }
    \vspace{-0.8em}
...
\IncludeCpp{Polynomial Operations}{PolynomialOp.cpp}
